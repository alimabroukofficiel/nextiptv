...
import apple from '../assets/devices/apple.svg'
import windows from '../assets/devices/windows.svg'
import amazon from '../assets/devices/amazon.svg'
    ...
    <div className="whyCard__list">
         <div className="whuCard__item">
             <div className="main__icon">
                 <Image src={android} width={35} height={35} alt="icon why iptvego tv"/>
             </div>
         ...
         <div className="whuCard__item">
             <div className="main__icon">
                <Image src={apple} width={30} height={30} alt="icon why iptvego money back"/>
         ...
         <div className="whuCard__item">
             <div className="main__icon">
                <Image src={windows} width={30} height={30} alt="icon why iptvego 4K"/>
         ...
         <div className="whuCard__item">
             <div className="main__icon">
                <Image src={amazon} width={45} height={45} alt="icon why iptvego support"/>
             </div>
             <div className="why__text">
                 <h3>دعم فني متخصص </h3>
